...
#TODO add links bw routers (hence adding the interfaces)
...
def addLinkBwRouters(self, data: dict, routers: dict):
    for firstInterface in data["links"]:
        ...
        info(firstRouter + " has interface " + firstInterface + " ip = " + addressOne + "\n")
        info(secondRouter + " has interface " + secondInterface + " ip = " + addressTwo + "\n")
